import{_ as s,c as n,o as a,a8 as e}from"./chunks/framework.Cpm-ryT4.js";const h=JSON.parse('{"title":"源码目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"workflow/源码阅读.md","filePath":"workflow/源码阅读.md","lastUpdated":1678680316000}'),p={name:"workflow/源码阅读.md"},l=e(`<ol><li>下载源码</li></ol><p>git clone <a href="https://github.com/vuejs/vue.git" target="_blank" rel="noreferrer">https://github.com/vuejs/vue.git</a> 或者<a href="https://github.com/vuejs/vue/tree/dev" target="_blank" rel="noreferrer">zip</a></p><ol start="2"><li><p>npm i</p></li><li><p>在 package.json -&gt; scripts 中的 dev 命令中添加 --sourcemap，这样就可以在浏览器中调试源码时查看当前代码在源码中的位置。</p></li></ol><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>{</span></span>
<span class="line"><span>  &quot;scripts&quot;: {</span></span>
<span class="line"><span>    &quot;dev&quot;: &quot;rollup -w -c scripts/config.js --sourcemap --environment TARGET:web-full-dev&quot;</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>4.npm run dev <img src="https://cdn.nlark.com/yuque/0/2021/png/292785/1635496174575-0b6ff95c-605d-4157-9d2c-42f5cd1771bf.png#clientId=u22b003c3-5731-4&amp;from=paste&amp;height=182&amp;id=bHX2k&amp;name=image.png&amp;originHeight=182&amp;originWidth=727&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;size=25838&amp;status=done&amp;style=none&amp;taskId=ua303496f-035d-4fdf-be69-c17abaa93a3&amp;title=&amp;width=727" alt="image.png"></p><h1 id="源码目录结构" tabindex="-1">源码目录结构 <a class="header-anchor" href="#源码目录结构" aria-label="Permalink to &quot;源码目录结构&quot;">​</a></h1><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>├── benchmarks                  性能、基准测试</span></span>
