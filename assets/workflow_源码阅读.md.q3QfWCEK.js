import{_ as n,c as a,a6 as p,o as e}from"./chunks/framework.C_m7SF9B.js";const u=JSON.parse('{"title":"源码目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"workflow/源码阅读.md","filePath":"workflow/源码阅读.md","lastUpdated":1731570819000}'),l={name:"workflow/源码阅读.md"};function r(i,s,c,t,o,b){return e(),a("div",null,s[0]||(s[0]=[p(`<ol><li>下载源码</li></ol><p>git clone <a href="https://github.com/vuejs/vue.git" target="_blank" rel="noreferrer">https://github.com/vuejs/vue.git</a> 或者<a href="https://github.com/vuejs/vue/tree/dev" target="_blank" rel="noreferrer">zip</a></p><ol start="2"><li><p>npm i</p></li><li><p>在 package.json -&gt; scripts 中的 dev 命令中添加 --sourcemap，这样就可以在浏览器中调试源码时查看当前代码在源码中的位置。</p></li></ol><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>
